...
@section('content')
    <!-- Hero Section -->
    <div class="min-h-screen flex items-center justify-center text-white bg-cover bg-center font-Fredoka"
        ...
        <div class="bg-black bg-opacity-50 p-8 rounded-lg max-w-2xl text-center font-medium">
            <h1 class="text-4xl  mb-4">Welcome to Network Monitoring</h1>
            <p class="text-lg mb-6">Monitor your network seamlessly and efficiently.</p>
            <div class="space-x-4">
                <a href="/register"
                    class="px-6 py-3 bg-[#953030] rounded-md text-lg font-medium hover:bg-[#D24E4E]">Register</a>
                <a href="/login"
                    class="px-6 py-3 bg-[#D24E4E] rounded-md text-lg font-medium hover:bg-[#953030]">Login</a>
            </div>
        </div>
    </div>

    <!-- Features Section -->
    <div class="container mx-auto py-16 px-6 font-Fredoka">
        <h2 class="text-3xl font-bold text-center text-gray-900 mb-12">Our Features</h2>
        <div class="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <!-- Feature 1 -->
            <div class="bg-white p-6 rounded-lg shadow-lg font-Fredoka">
    ...
    <!-- Footer Section -->
    <footer class="bg-[#953030] text-white py-8 font-Fredoka">

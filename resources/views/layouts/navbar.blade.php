            ...
            <div class="relative flex items-center justify-between h-16">
                ...
                <div class="flex-1 flex items-center justify-between sm:items-stretch sm:justify-between">
                    <div class="flex-shrink-0">
                        <a href="/dashboard" class="text-2xl font-bold text-gray-900">MyApp</a>
                    </div>
                    <div class="hidden sm:flex sm:space-x-4">
                        <a href="/dashboard" class="text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Monitoring</a>
